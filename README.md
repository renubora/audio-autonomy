...
Uses fullcalender.io, which has a great API and documentation. It a front-end interface, so we connected it to our own back-end system. It also uses Aspect.com's free VoiceXML IVR platform service "Prophecy"  (we used it as a Voxeo product, before Aspect purchased Voxeo).
